...
def train(feature, label, feature_names, test_size=0.2, id=0, cls='entropy', max_depth=None, min_samples_leaf=1, splitter="best", min_weight_fraction_leaf=0.0, class_weight="balanced"):
